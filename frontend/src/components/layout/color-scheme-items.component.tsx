...
export const ColorSchemeItems = () => {
  ...
  return (
    <PopupMenu.Items>
      <PopupMenu.Item>
        <RadioButton value={ColorSchemeMode.Light} onClick={() => setColorScheme(ColorSchemeMode.Light)} checked={colorScheme === ColorSchemeMode.Light}>
          Ljust <Sun className={colorScheme === ColorSchemeMode.Light ? '' : 'opacity-50'} />
        </RadioButton>
      </PopupMenu.Item>
      <PopupMenu.Item>
        <RadioButton value={ColorSchemeMode.Dark} onClick={() => setColorScheme(ColorSchemeMode.Dark)} checked={colorScheme === ColorSchemeMode.Dark}>
          Mörkt <Moon className={colorScheme === ColorSchemeMode.Dark ? '' : 'opacity-50'} />
        </RadioButton>
      </PopupMenu.Item>
      <PopupMenu.Item>
        <RadioButton value={ColorSchemeMode.System} onClick={() => setColorScheme(ColorSchemeMode.System)} checked={colorScheme === ColorSchemeMode.System}>
