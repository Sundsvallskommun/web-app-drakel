...
/**
 * The payments SSBTEK reports to the errand's sökande, read live through careM (which logs the read on the
 * errand). The errand is given as its route segment — errand number or id. careM picks the period: month M−2
